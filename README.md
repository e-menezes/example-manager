# Example Manager
A app to iframed with any web material to show examples of code and open dynamically in plnkr.
___
...
# Walkthrough (It uses NG6-starter)
## Build System
...
## Running the App (It uses NG6-starter)
